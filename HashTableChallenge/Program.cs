...
namespace HashTableChallenge
{
    ...
    // CHALLENGE: Write program that will iterate through each element of the students array and insert them into a hashtable.
    // If student wioth the same ID already exist in the hashtable skip it and display the following error:
